...
public class NoteActivity_Student extends AppCompatActivity implements ListView.OnItemClickListener{
...
/*
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(activity,NoteCreateActivity_Faculty.class);
