...
public class GridAdapter_Fac extends BaseAdapter{
    ArrayList names;

    public static Activity activity;

    public GridAdapter_Fac(Activity activity, ArrayList names) {
        GridAdapter_Fac.activity = activity;
        this.names = names;
    }
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        else if(names.get(position).toString().equals("NOTES"))
        {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchingIntent = new Intent(activity, NoteActivity_Faculty.class);
                    activity.startActivity(launchingIntent);
                }
            });
            Animation anim = new ScaleAnimation(
        ...
        else if(names.get(position).toString().equals("PROFILE"))
        {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchingIntent = new Intent(activity, ProfileActivity_Faculty.class);
                    activity.startActivity(launchingIntent);
                }
            });
            Animation anim = new ScaleAnimation(
        ...
        else if(names.get(position).toString().equals("NOTICE"))
        {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchingIntent = new Intent(activity, NoticeActivity_Faculty.class);
                    activity.startActivity(launchingIntent);
                }
            });
            Animation anim = new ScaleAnimation(
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            if(cr!=null)
            {
                ...
                while(!cr.isAfterLast()) {
                    ...
                    Log.d("GridAdapter_Fac.class", "Cached " + cr.getString(0));
                    cr.moveToNext();
                }
            }else
                Log.d("GridAdapter_Fac.class", "No SUBS" + cr.getString(0));
            ...
            builder.setView(v)
                    ...
                    .setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Cursor cr = AppBase_Faculty.handler.execQuery(qx);
                            String subnames = "";
                            if(cr!=null)
                            {
                                cr.moveToFirst();
                            ...
                            Cursor cursor = AppBase_Faculty.handler.execQuery("SELECT * FROM ATTENDANCE WHERE datex = '" +
                                    date +"' AND hour = " + hour.getText() + ";");
                            if(cursor==null||cursor.getCount()==0)
                            {
                                Intent launchingIntent = new Intent(AppBase_Faculty.activity, AttendanceActivity_Faculty.class);
                                launchingIntent.putExtra("DATE", date);
                                launchingIntent.putExtra("PERIOD", hour.getText().toString());
                                AppBase_Faculty.activity.startActivity(launchingIntent);
                            }else {
