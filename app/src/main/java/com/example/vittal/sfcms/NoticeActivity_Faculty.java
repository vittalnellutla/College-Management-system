...
public class NoticeActivity_Faculty extends AppCompatActivity implements ListView.OnItemClickListener{
...
*/
    ...
    private void loadNotice() {
        ...
        Cursor cursor = AppBase_Faculty.handler.execQuery(qu);  // AppBase Admin -> Faculty
