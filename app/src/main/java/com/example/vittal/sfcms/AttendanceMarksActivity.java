...
public class AttendanceMarksActivity extends AppCompatActivity{

    DatabaseHandler handler = AppBase_Student.handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_marks);
        dates = new ArrayList<>();
 ...
 /*       FloatingActionButton fab = findViewById(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(profileActivity,EditStudent_Student.class);
...
*/
    ...
    public void find(View view) {
        ...
        Cursor cursor = AppBase_Student.handler.execQuery(qu);
        //Start Count Here
        ...
        if(cur!=null&&cur1!=null)
        {
            ...
            try{
                ...
                if(att<=0)
                    att = 0f;
                Log.d("AttendanceMarksActivity","Total = " + cur.getCount() + " avail = "+cur1.getCount() + " per " + att);
...
/*
    public void editStudent(MenuItem item) {
        Intent launchIntent  = new Intent(this,EditStudent_Student.class);
        startActivity(launchIntent);
    }
