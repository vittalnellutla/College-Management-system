...
import com.example.vittal.sfcms.EditStudent_Admin;
...
public class ProfileActivity_Admin extends AppCompatActivity{
    ...
    DatabaseHandler handler = AppBase_Admin.handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(profileActivity,EditStudent_Admin.class);
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (AppBase_Admin.handler.execAction(qu)) {
                            ...
                            if (AppBase_Admin.handler.execAction(qa)) {
    ...
    public void find(View view) {
        ...
        if(cur!=null&&cur1!=null)
        {
            ...
            try{
                ...
                if(att<=0)
                    att = 0f;
                Log.d("ProfileActivity_Admin","Total = " + cur.getCount() + " avail = "+cur1.getCount() + " per " + att);
    ...
    public void editStudent(MenuItem item) {
        Intent launchIntent  = new Intent(this,EditStudent_Admin.class);
        startActivity(launchIntent);
    }
}
